...
class SqlHandle {
public:
	SqlHandle (SqlHandle<TypeValue>&& other) noexcept {
...
public:
	...
	SqlStatement (SqlStatement&& other) noexcept : SqlHandle (std::move (other)) {}
...
public:
	...
	SqlConnection (SqlConnection&& other) noexcept : SqlHandle (std::move (other)) {}
...
public :
	...
	SqlEnvironment (SqlEnvironment&& other) noexcept : SqlHandle (std::move (other)) {}
