...
{
 172,0,65,69,65,81,65,73,99,66,71,113,74,88,69,101,48,49,49,49,
...
using shared_lifetime_unordered_map = std::unordered_map<K, V, std::hash<K>, std::equal_to<K>, shared_lifetime_allocator<std::pair<const K, V>>>;
...
#line 33 "Db2EmbeddedSqlRepeatPrinter.sqx"
...
#line 56 "Db2EmbeddedSqlRepeatPrinter.sqx"
...
#line 58 "Db2EmbeddedSqlRepeatPrinter.sqx"
...
public:
	Db2EmbeddedSqlRepeatPrinter(const CommandLine& c) : _fragments(shared_lifetime_allocator<pair<const StringSlice, int>>(true)){
...
{
#line 76 "Db2EmbeddedSqlRepeatPrinter.sqx"
...
{
#line 81 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlastrt(sqla_program_id, &sqla_rtinfo, &sqlca);
#line 81 "Db2EmbeddedSqlRepeatPrinter.sqx"
...
{
#line 100 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlastrt(sqla_program_id, &sqla_rtinfo, &sqlca);
#line 100 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlaaloc(2,1,2,0L);
    {
...
{
#line 106 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlastrt(sqla_program_id, &sqla_rtinfo, &sqlca);
#line 106 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlacall((unsigned short)21,0,0,0,0L);
#line 106 "Db2EmbeddedSqlRepeatPrinter.sqx"
...
#line 106 "Db2EmbeddedSqlRepeatPrinter.sqx"
	...
	virtual void OutputPairs(int x, int y, StringSlice repeat, StringSlice complement) {
...
{
#line 121 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlastrt(sqla_program_id, &sqla_rtinfo, &sqlca);
#line 121 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlaaloc(2,5,4,0L);
    {
...
{
#line 126 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlastrt(sqla_program_id, &sqla_rtinfo, &sqlca);
#line 126 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlacall((unsigned short)21,0,0,0,0L);
#line 126 "Db2EmbeddedSqlRepeatPrinter.sqx"
...
#line 126 "Db2EmbeddedSqlRepeatPrinter.sqx"
	...
	virtual void  AfterEverySequence(std::vector<int> repeatCount) {
...
{
#line 133 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlastrt(sqla_program_id, &sqla_rtinfo, &sqlca);
#line 133 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlaaloc(2,1,5,0L);
    {
...
#line 133 "Db2EmbeddedSqlRepeatPrinter.sqx"
	...
	virtual void Initialize(const CommandLine& c) {
		_probability = c.GetProbability();
		_confidence = c.GetConfidence();
		_minLength = c.GetFragmentLength();
		string s;
		c.GetIsMathematical() ? s = "mat": s = "bio";
		c.GetIsRepeat() ? s = s + "rep" : s = s + "pal";
		_type = s;
	}

	virtual bool InitializeForEverySequence(const std::string& seqName, const int version, const CommandLine& c) {
		_sequenceName = seqName;
		_seqId = 0;
		string rType = "";
		_version = version;
...
{
#line 165 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlastrt(sqla_program_id, &sqla_rtinfo, &sqlca);
#line 165 "Db2EmbeddedSqlRepeatPrinter.sqx"
...
{
#line 167 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlastrt(sqla_program_id, &sqla_rtinfo, &sqlca);
#line 167 "Db2EmbeddedSqlRepeatPrinter.sqx"
...
{
#line 171 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlastrt(sqla_program_id, &sqla_rtinfo, &sqlca);
#line 171 "Db2EmbeddedSqlRepeatPrinter.sqx"
...
{
#line 173 "Db2EmbeddedSqlRepeatPrinter.sqx"
  sqlastrt(sqla_program_id, &sqla_rtinfo, &sqlca);
#line 173 "Db2EmbeddedSqlRepeatPrinter.sqx"
